...
def app():
    ...
    BadWords_rule = """"
    BadWordsRule: A Regra de 'Bad Words' verifica se a palavra analisada está na lista de palavras que flexiona gênero. 
    ...
    A função who_w_indicativeVerb() utiliza o processo de lemmatização para identificar o radical da palavra analisada. 
    ...
    Uma frase que seria neutralizada usando essa etapa de refatoração, por exemplo, é:
    "Os engeheiros estão trabalhando" > "As pessoas engenheiras estão trabalhando"
